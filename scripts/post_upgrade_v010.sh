...
if installed != discovery.__version__ or installed != "0.10.0":
    raise SystemExit(
        f"version mismatch: installed={installed} module={discovery.__version__} expected=0.10.0"
    )
PY
...
printf '\nv0.10 scientific structure discovery validation passed.\n'
